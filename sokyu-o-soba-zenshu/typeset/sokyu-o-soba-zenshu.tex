...
\newmdenv[
  ...
  skipabove=10pt,
  skipbelow=10pt,
  splittopskip=18pt,    % more breathing room when a box continues onto the next page
  splitbottomskip=8pt,
...
\url{https://dl.ndl.go.jp/pid/804042}\\
...
\section*{The Honma Corpus}

A point worth surfacing before the text begins: Japanese scholarly
consensus is that \emph{no Edo-period autograph} of any work
attributed to Honma survives. The chain of transmission runs from
Honma's teachings, recorded in his lifetime by his student Kuzuoka
Isoka (\jp{葛岡五十香}); through late-Edo and Meiji hand-copies passing
within the Honma family in Sakata; to Hayasaka's own 1900 manuscript
held at K\=oky\=u Bunko (\jp{光丘文庫}); and finally to the 1910 print
edition translated here.\tn{The 1900 K\=oky\=u Bunko manuscript ---
\textit{Sh\=onai Honma S\=oky\=u-\=o Isho} (\jp{荘内本間宗久翁遺書})
--- is the proximate ancestor of the present text and is freely
viewable online via the ADEAC archive of Sakata City. The 1910
edition's preface is candid about the variant-reading problem; it
is exactly Hayasaka's motivation for producing a systematic
recension.} The book in your hands is one generation downstream of a
Meiji manuscript, which is itself several generations downstream of
whatever Honma actually wrote. The teaching is consistent across
the surviving recensions, but the reader should not picture this as
a transcription of Honma's hand. Treat it instead as the most
carefully assembled witness to a tradition whose Edo originals are
lost.

A reader new to the literature should also know that several
distinct titles refer to essentially the same body of material.
\textit{S\=oky\=u-\=o Hiroku} (\jp{宗久翁秘録}) is the received core,
a $\sim$157-section collection of aphorisms, position rules, and
market psychology. \textit{S\=oky\=u-\=o S\=oba Zensh\=u}
(\jp{宗久翁相場全集}) --- this book --- is Hayasaka's 1910 collation
of the Hiroku plus annotation. \textit{Sh\=onai Honma S\=oky\=u-\=o
Isho} is the 1900 manuscript ancestor named above.
\textit{S\=oba Sanmai-den} (\jp{相場三昧伝}) and \textit{S\=oba
San'i no Den} (\jp{相場三位の伝}) are the same aphoristic corpus
under different titles --- where they appear as separate works in
catalogues, the apparent independence is bibliographic, not
textual.

Three further titles often cited as ``Honma's writings'' have no
textual basis and should be treated with suspicion. \textit{Hons\=o
Bakuna-ken} (\jp{本宗莫那剣}) appears only as a disputed title; no
manuscript has ever surfaced. \textit{Sakata Senh\=o}
(\jp{酒田戦法}) is a twentieth-century umbrella term for chart
doctrine, popularized by Sh\=owa-era brokerage marketing; there is
no Edo book of that name, despite its appearance in
English-language trading literature since Steve Nison's
\textit{Japanese Candlestick Charting Techniques} (1991).
\textit{Sakata Senjutsu} (\jp{酒田戦術}) rests on a single
preface-passage attestation in the K\=oky\=u Bunko manuscript
claiming Honma compiled his memoranda into a book of that name in
his later years; no such volume has ever been found. A fourth body
of text, sold in English under titles like \textit{The Fountain of
Gold --- The Three Monkey Record of Money}, belongs to a separate
Edo tradition altogether: it is Ushida Gonzabur\=o's
\textit{Sanen Kinsen Hiroku} (Osaka/Ise lineage, 1755), translated
in this project's companion volume.

\section*{Honma and the Candlestick Myth}

\begin{sloppypar}
Honma did not invent candlestick charts. The Nippon Technical
Analysts Association dates the candlestick form to the Meiji~30s
(1897--1906), roughly a century after Honma's death in 1803.\tn{Steve
Nison himself acknowledged this in \textit{Beyond Candlesticks}
(1994, p.\,14), noting that his subsequent research indicated Honma
``likely did not use candlestick charts.'' By that point the
narrative was already in wide circulation in English.} The pattern
taxonomy English readers know as the ``Sakata Five Methods''
(\jp{酒田五法}) was first compiled by Arai Teishir\=o
(\jp{新井貞四郎}) in his 1950 book \textit{Sakata Senjutsu Sh\=okai}
(\jp{酒田戦術詳解}), drawing on Sh\=owa-era brokerage practice
rather than any Edo source. Sh\=onai Securities --- the Sakata
investment firm in Honma's own hometown --- notes plainly in their
commentary on the \textit{S\=oky\=u-\=o Hiroku} that the text
``contains no discussion of charts whatsoever'' --- in the original,
\jp{チャートの話は一切ありません}.
\end{sloppypar}

What Honma did leave, as preserved in the present book, is a
discipline of position management and market psychology: when to
enter, when to wait, how the crowd's mood inverts at extremes, how
to read the rhythm of price exhaustion. The visual pattern apparatus
that bears his name was attached to the legend long after his
death.
...
\input{fragments/upper_03-15}

% --- Articles 16--42 ---
\input{fragments/upper_16-42}

% --- Articles 43--66 ---
\input{fragments/upper_43-66}

% --- Articles 67--73 (end of Upper Volume) + Lower Volume Articles 1--2 ---
\input{fragments/transition_67-73_lower_01-02}

% --- Lower Volume Articles 3--42 ---
\input{fragments/lower_03-42}

% --- Lower Volume Articles 43--85 + Historical Price Records ---
\input{fragments/lower_43-85_prices}
